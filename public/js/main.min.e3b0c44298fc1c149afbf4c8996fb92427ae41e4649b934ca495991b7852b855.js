        ...
        init: function() {
            $(document).ready(function() {
               $(document).on('keypress', '.td-search-input', function(e) {
                    ...
                    var query = $(this).val();
                    var searchPage = "https://dwes.infenlaces.com/search/?q=" + query;
...
(function($) {
    ...
    $('.language-plantuml').parent().replaceWith(function() {
        ...
        return $('<img src="{{.svg_image_url | _default "http://www.plantuml.com/plantuml/svg/"}}' + encode64(deflate(s, 9)) + '">')
    });
})(jQuery);
{{ end }}
{{ end }}
